...
my $dbh;
my $filedbh;
my $CONF_FILE="$ENV{HOME}/.dailyphocadownloads.ini";
my $NotifyEmail="";
my $FILEEDITOR = $ENV{EDITOR};
my $TempFile = "/tmp/dailyphocadown_temp-$$.txt";
my $SortedFile = "/tmp/dailyphocadown_sorted-$$.txt";
...
print("dailyphocadownloads log parser ($VERSION)\n");
print("===========================================\n");
